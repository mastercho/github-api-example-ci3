...
class Github {
    ...
    public function get_repository($owner, $repo) {
        return $this->curl('repos/' . $owner . '/' . $repo);
    }
    ...
    public function list_contributors($owner, $repo) {
        return $this->curl('repos/' . $owner . '/' . $repo . '/contributors');
    }
    ...
    public function search_repo($name, $page) {
        return $this->curl('search/repositories?q=' . $name . '&order=desc&per_page='.$page);
    }
